    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        <motion.h1
          ...
          className="text-4xl font-bold mb-12 bg-gradient-to-r from-gray-200 to-gray-400 bg-clip-text text-transparent"
        >
          Available Courses
        </motion.h1>
            ...
            >
              <Link href={`/courses/${course._id}`} className="block h-full">
                <div className="relative group h-full">
                  ...
                  <div className="relative bg-gray-900/80 backdrop-blur-xl rounded-xl border border-gray-800 shadow-2xl p-6 h-full flex flex-col">
                    <h2 className="text-xl font-semibold mb-4 text-white group-hover:text-gray-300 transition-colors duration-300">
                      {course.title}
                    </h2>
                    <p className="text-gray-300 mb-6 flex-grow">
                      {course.description}
                    </p>
                    <div className="flex justify-between items-center text-sm text-gray-400 pt-4 border-t border-gray-800">

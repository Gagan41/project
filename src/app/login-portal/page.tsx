...
export default function LoginPortal() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative px-4 bg-gradient-to-br from-black via-gray-900/20 to-black">
      {/* Background Elements */}
      ...
      >
        <div className="relative">
          ...
          <div className="relative bg-gray-900/80 backdrop-blur-xl rounded-xl border border-gray-800 shadow-2xl p-8 sm:p-10">
            {/* Back Button */}
            <motion.button
              whileHover={{ x: -5 }}
              onClick={() => router.push("/")}
            ...
            >
              ...
              <Image
                ...
                width={100}
                height={100}
                className="relative rounded-full border-2 border-gray-800 shadow-lg shadow-gray-900/20"
              />
            </motion.div>
            ...
            <motion.p
              ...
              className="text-sm text-gray-400 italic mb-10 px-6 leading-relaxed text-center max-w-xl mx-auto"
            >
            ...
            >
              <Link
                href="/register"
                className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-black bg-yellow-400 rounded-xl transition-all duration-300 transform hover:scale-105 hover:bg-black hover:text-white hover:shadow-lg hover:shadow-gray-900/25"
              >
